...
namespace CreatureModule
{
	...
	public class Creature {
		...
		public void LoadFromData(ref Dictionary<string, object> load_data)
		{
			...
			for (int i = 0; i < global_uvs.Count; i+=2) {
				global_uvs[i + 1] = 1.0f - global_uvs[i + 1];
			}
	...
	public class CreatureManager {
		...
		public bool use_custom_time_range;
		...
		public bool SetActiveAnimationName(string name_in, bool check_is_active=false)
		{
			...
			if (check_is_active) {
				if (string.Equals (active_animation_name, name_in)) {
					return false;
				}
			}
